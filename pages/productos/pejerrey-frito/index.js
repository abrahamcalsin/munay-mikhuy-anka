...
const PejerreryFrito = () => {
  return (
    <MainLayout>
      ...
      <div className="product-pejerrey-frito">
        <div className="container-responsive product-flex">
          <div>
            <img src="/images/platos-tipicos/pejerrey-frito.png" alt="Pejerrey Frito" />
          </div>
          <div>
